...
export default function HeroSection() {
  return (
    <section className="w-full min-h-screen overflow-hidden bg-slate-950 text-white">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col overflow-hidden bg-slate-950 px-4 py-4 sm:px-6 lg:flex-row lg:px-0 lg:py-0">
        ...
        <div className="mt-6 flex w-full flex-1 items-center justify-center rounded-[2rem] bg-yellow-400 px-6 py-10 lg:mt-0 lg:justify-end lg:rounded-l-none lg:rounded-r-[2rem] lg:px-12 lg:py-16">
          <div className="flex h-full w-full max-w-[34rem] items-center justify-center rounded-[2rem] border border-yellow-500/80 bg-yellow-500/90 p-8 shadow-[0_30px_70px_rgba(0,0,0,0.18)]">
